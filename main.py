...
from network import RNINetwork
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--name",
        type=str,
        default="RNI_main_neutral_batch_256_lr_0.0001_NOISE_0.003",
        help="experiment name",
    )
    parser.add_argument("--epochs", type=int, default=20000, help="epochs")
    parser.add_argument("--batch_size", type=int, default=256, help="batch size")
    parser.add_argument(
        "--learning_rate", type=float, default=0.0001, help="Adam learning rate"
    )
    ...
    Input_set, Output_set = load_dataset(
        path, transpose=False
    ...
    # Train network
    model = RNINetwork(input_size, 308, noise_level=args.noise_level / trn_std)
